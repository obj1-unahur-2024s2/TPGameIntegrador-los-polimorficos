...
const nivel2 = new Nivel(nivel = 2, enemigos = monstruosNivel2, bloquesMapa = bloquesMapa2, image = fondoNivel2, sonidoNivel = musicaNivel2, pociones = pocionesNivel1) //crear todo lo que va adentro
...
[8, 7], [8, 3], [12, 11], [12, 10], [12, 6], [12, 5], [12, 4], [12, 3]],
nivel = 2
)
